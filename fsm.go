...
// E is the event type
// S is the state type.
func New[E constraints.Ordered, S constraints.Ordered](initState S, transitions Transforms[E, S]) IFsm[E, S] {
...
// E is the event type
// S is the state type.
func NewUnsafeFSM[E constraints.Ordered, S constraints.Ordered](initState S, transitions Transforms[E, S]) IFsm[E, S] {
