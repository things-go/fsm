...
func testIFsmClone(t *testing.T, newFromTransitions func(initState string, ts Translator[string, string]) IFsm[string, string]) {
	ts := NewTranslator([]Transform[string, string]{
...
func testSameState(t *testing.T, newFsm func(initState string, ts []Transform[string, string]) IFsm[string, string]) {
	fsm := newFsm(
		"start",
...
func testState(t *testing.T, newFsm func(initState string, ts []Transform[string, string]) IFsm[string, string]) {
	fsm := newFsm(
		"walking",
		[]Transform[string, string]{
...
func testAvailTransitionEvent(t *testing.T, newFsm func(initState string, ts []Transform[string, string]) IFsm[string, string]) {
	fsm := newFsm(
		"closed",
		[]Transform[string, string]{
			{Event: "open", Src: []string{"closed"}, Dst: "open"},
...
func testInappropriateEvent(t *testing.T, newFsm func(initState string, ts []Transform[string, string]) IFsm[string, string]) {
	fsm := newFsm(
		"closed",
		[]Transform[string, string]{
			{Event: "open", Src: []string{"closed"}, Dst: "open"},
...
func testNonExistEvent(t *testing.T, newFsm func(initState string, ts []Transform[string, string]) IFsm[string, string]) {
	fsm := newFsm(
		"closed",
		[]Transform[string, string]{
			{Event: "open", Src: []string{"closed"}, Dst: "open"},
...
func testMultipleSources(t *testing.T, newFsm func(initState string, ts []Transform[string, string]) IFsm[string, string]) {
	fsm := newFsm(
		"one",
		[]Transform[string, string]{
...
func testMultipleEvents(t *testing.T, newFsm func(initState string, ts []Transform[string, string]) IFsm[string, string]) {
	fsm := newFsm(
		"start",
		[]Transform[string, string]{
